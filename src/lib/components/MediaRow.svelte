...
{#if items.length > 0}
	<section class="space-y-3">
		...
		<div class="relative -m-3">
			<div class="flex gap-4 overflow-x-auto scroll-smooth p-3 scrollbar-hide" style="-webkit-mask-image: linear-gradient(to right, black calc(100% - 48px), transparent); mask-image: linear-gradient(to right, black calc(100% - 48px), transparent); scroll-snap-type: x proximity;">
