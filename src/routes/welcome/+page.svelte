			...
			{#if step === 0}
				...
				<div class="relative">
					...
					<div class="relative z-10 flex flex-col items-center pt-16 pb-8">
						...
						<a href="https://github.com/scope-player/scope" target="_blank" rel="noopener noreferrer" class="mt-6 inline-flex items-center gap-1.5 text-[12px] text-text-muted/40 transition-colors hover:text-text-muted">
