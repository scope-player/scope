				...
				{:else if activeSection === 'about'}
					<div class="space-y-6">
						...
						<div class="settings-card space-y-4">
							...
							<div class="setting-row">
								<p class="setting-label">Source</p>
								<a href="https://github.com/scope-player/scope" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1.5 text-sm text-text-secondary transition hover:text-text">
